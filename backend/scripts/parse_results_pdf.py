...
# La curaduria de nombres vive en el dominio: la comparten el parser de
# resultados y el de programas de competencia.
from natacion_chile.domain.person_name import (  # noqa: E402
    ACCENTED,
