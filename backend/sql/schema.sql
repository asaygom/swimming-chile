...
CREATE TABLE live_heat_movement (
    id BIGSERIAL PRIMARY KEY,
    competition_id BIGINT NOT NULL REFERENCES competition(id) ON DELETE CASCADE,
    previous_publication_id BIGINT REFERENCES meet_program_publication(id),
    ...
    resulting_publication_id BIGINT NOT NULL REFERENCES meet_program_publication(id),
...
CREATE INDEX idx_live_heat_movement_competition_occurred
    ON live_heat_movement(competition_id, occurred_at DESC, id DESC);
